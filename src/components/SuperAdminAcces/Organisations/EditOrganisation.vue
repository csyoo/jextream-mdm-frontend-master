            ...
            <v-col cols="6">
              <div style="border: 2px solid grey; height: 40px" class="ml-2">
                <form name="add" for="cars">
                  Select Color :
                  <select id="cars" v-model="colorCode">
                    <option
  ...
  watch: {
    editDialog: {
      handler() {
        ...
        this.orgCode =
          this.editDetails.organization_code != undefined
            ? this.editDetails.organization_code
            : "";
        ...
        this.addr1 =
          this.editDetails.address_first != undefined
            ? this.editDetails.address_first
            : "";
       
        this.city =
          this.editDetails.organization_city != undefined
            ? this.editDetails.organization_city
            : "";
        this.postalCode =
          this.editDetails.postal_code != undefined
            ? this.editDetails.postal_code
            : "";
